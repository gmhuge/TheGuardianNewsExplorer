...
public class NewsActivity extends AppCompatActivity implements LoaderCallbacks<List<NewsStory>> {
    ...
    private static final String USGS_REQUEST_URL =
            "https://content.guardianapis.com/search?q=debate&tag=politics/politics&from-date=2018-01-01&show-tags=contributor&api-key=a5b3f835-c57b-4baa-9a63-7eeabd6b1c5b";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        earthquakeListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                NewsStory currentEarthquake = mAdapter.getItem(position);
